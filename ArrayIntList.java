...
// I have updated this ArrayIntList.java file with the methods requested on Assignment #8.
...
public class ArrayIntList implements Iterable<Integer> {
	...
	public ArrayIntList upToNowTotal() {
		...
		//Variable sum reseted and adding up.
		int sum = 0;
		for (int i=0; i<size; i++) {
			sum += get(i);
			list.add(sum);
	...
	public boolean isPairSorted() {
		...
		//Confirming if the pairs are sorted and returning its final answer.
	...
	// Problem from Exercise #14 from Chapter 15, page 972:
	// This method lists all inversions in a list of integers.
	// My #QA Document will have more info on the exercise.
